...
public class EmployeeController {
    ...
    public ResponseEntity<PagedResponse<EmployeeDTO>> getEmployeeByActiveTrue(
    		...
    		@RequestParam(name ="sortBy", defaultValue="id")String sortBy,
    		@RequestParam(name ="direction", defaultValue="asc")String direction) {
        PagedResponse<EmployeeDTO> employeesDTO = employeeService.getEmployeeByActiveTrue(page,size,sortBy,direction);
        return new ResponseEntity<PagedResponse<EmployeeDTO>>(employeesDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<PagedResponse<EmployeeDTO>> getEmployeeNameStartingWith(@PathVariable(name = "prefix") String prefix,
    		@RequestParam(name ="page", defaultValue="0") int page,
    		@RequestParam(name ="size", defaultValue="5")int size,
    		@RequestParam(name ="sortBy", defaultValue="id")String sortBy,
    		@RequestParam(name ="direction", defaultValue="asc")String direction){
        PagedResponse<EmployeeDTO> employees = employeeService.getEmployeeNameStartingWith(prefix,page,size,sortBy,direction);
        return new ResponseEntity<PagedResponse<EmployeeDTO>>(employees, HttpStatus.OK);
    }

    @GetMapping("/salaryGreaterThanAndDepartment")
    public ResponseEntity<PagedResponse<EmployeeDTO>> getEmployeeSalaryGreaterThanAndDepartment(@RequestBody Employee employee,
    		@RequestParam(name ="page", defaultValue="0") int page,
    		@RequestParam(name ="size", defaultValue="5")int size,
    		@RequestParam(name ="sortBy", defaultValue="id")String sortBy,
    		@RequestParam(name ="direction", defaultValue="asc")String direction){
        PagedResponse<EmployeeDTO> employees = employeeService.getEmployeeSalaryGreaterThanAndDepartment(employee.getSalary(), employee.getDesignation(),page,size,sortBy,direction);
        return new ResponseEntity<PagedResponse<EmployeeDTO>>(employees, HttpStatus.OK);
    }


    @GetMapping("/salaryBetween/{start}/{end}")
    public ResponseEntity<PagedResponse<EmployeeDTO>> getEmployeeSalaryBetween(@PathVariable(name = "start") Double startSalary, @PathVariable(name = "end") Double endSalary,
    		@RequestParam(name ="page", defaultValue="0") int page,
    		@RequestParam(name ="size", defaultValue="5")int size,
    		@RequestParam(name ="sortBy", defaultValue="id")String sortBy,
    		@RequestParam(name ="direction", defaultValue="asc")String direction) {
